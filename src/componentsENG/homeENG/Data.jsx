...
export const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Juan Manitta
        {/* <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I am a Front-end developer with experience in UI/UX and responsive design. 
        These are my <b>projects.</b></p>
